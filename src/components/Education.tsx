...
const Education = () => {
    ...
    return (
        <section id="education" className="py-24 px-4 bg-slate-100 dark:bg-[#020617] relative overflow-hidden border-t border-slate-200 dark:border-white/5">
                    ...
                    {educationItems.map((edu, index) => (
                        <div key={index} className="p-8 rounded-[30px] bg-slate-900 border-2 border-blue-900 shadow-xl hover:shadow-2xl transition-all group">
                            <div className="flex flex-col h-full text-left">
                                ...
                                <div className="mt-auto pt-4 flex items-center gap-2 text-slate-400 text-sm font-black">
